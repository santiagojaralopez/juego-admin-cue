    ...
    <div className="w-screen h-screen flex flex-col gap-32 items-center justify-center bg-cue-blue">
      <div className="w-[70%] h-auto flex gap-2 items-center justify-center">
        ...
        <div className="flex flex-col text-start">
          ...
          <p className="text-cue-white font-calibri text-[25px]">Desarrollado con ❤️ por Santiago Jaramillo López para el Programa de Administración de Empresas Dual</p>
        </div>
      </div>
